...
-   **transformation** for skew x-variables to be transformed into a more evenly spaced. A _power transformation_ of the type $x^p$ for $0<p<1$, where p=0 usualy is defines as $\log(x)$.
